...
define(['sb_light/globals', "sb_light/utils/ext"], function(sb, E) {
	...
	var urls = {
		...
		ADMIN_LICENSE_SUSPEND:		{url: "/admin/suspend_company/%id%.js", 				post:false, normalParams:true},
		...
		ADMIN_RANDOMIZE:			{url: "/admin/randomize_progress_values/%id%.js", 		post:false, normalParams:true},
		ADMIN_RANDOMIZE_HISTORY:	{url: "/admin/randomize_progress_history/%id%.js",		post:false, normalParams:true},
